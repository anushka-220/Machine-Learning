...
def formation_central_region(Pn1):
    ...
    inertia_tensor = np.cov(Pn1, rowvar=False)

    # Calculate eigenvalues and eigenvectors of the tensor
    ...
    while current_radius < initial_radius:
        ...
        # Create a circular mask centered at (center_i, center_j)
        ...
        # Find the label corresponding to the central region
